...
<div class='page-wrapper'>
    <form action='<?=URL_ROOT.ROUTE_POST_NEWS;?>' method='post'>
        <?=($isEdit?'<input type="hidden" name="news[id]" value="'.$news["newsID"].'"/>':null)?>
        <div class='bs-callout bs-callout-danger bs-callout-custom bc-dash'>
            <h4><?=$i18nHeadline?></h4>
        ...
        <div class='bs-callout bs-callout-primary bs-callout-custom bc-dash'>
            ...
            <div class="callout-content row">
                ...
                <div class='form-group'>
                    ...
                    <small id="edPostCoverImage_noImage">Keine Bilder im Beitrag gefunden</small>
                </div>
            </div>
        </div>
