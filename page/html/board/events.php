...
<div class='page-wrapper'>
    ...
    <div class='row row-sep'>
        <div class='js-switch js-template-list row' data-target='#eventList' data-template-list data-template-item='#tmpEventListRow'>
            <div class='switch col-xs-3 hc-warning' data-url='get/?t=events&e=all'><span class='card'><i class='fa fa-3x fa-star'></i>Alle</span></div>
            <div class='switch col-xs-3 hc-primary active' data-url='get/?t=events&e=public'><span class='card'><i class='fa fa-3x fa-globe'></i>Öffentlich</span></div>
            <div class='switch col-xs-3 hc-danger' data-url='get/?t=events&e=private'><span class='card'><i class='fa fa-3x fa-lock'></i>Privat</span></div>
            <div class='switch col-xs-3 hc-warning<?=$clanSwitchClass?>' data-url='get/?t=events&e=clanwars'><span class='card'><i class='fa fa-3x fa-trophy'></i>Clanwars</span></div>
        </div>
    </div>
    <hr>
